...
* **tflint:** 🐛 bump Azure rules version, fix signature bug f722808

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 6fb638b
* **deps:** update dependency opentofu to v1.12.2 84c339b
* **deps:** update dependency opentofu to v1.12.3 6708405
* **deps:** update dependency opentofu to v1.12.4 24ad44f
* **deps:** update dependency tflint to v0.63.1 198af3d
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 3063602
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 a0ff813

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 02e8834

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu af9d6fd
* **deps:** update dependency opentofu to v1.11.7 7a84898
* **deps:** update dependency opentofu to v1.12.0 20dfd77
* **deps:** update dependency terraform-docs to v0.23.0 00fe42e
* **deps:** update dependency terraform-docs to v0.24.0 1f6eef3
* **deps:** update dependency tflint to v0.62.1 e881e42
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 5a63dff
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 7ea7d25
* **deps:** update tools cad9c05
* **pre-commit:** 🔧 move to prek 40755d1
* **tfdocs:** bump tfdocs to v0.22 🔧 ec8507c

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ e1789b3

### Code Refactoring

* update module structure and Github actions 👷 d1924b1

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 36e680d
* **deps:** 🔗 bump tflint rules version 07396e4
* **deps:** update dependency trivy to v0.69.2 708698d
* **deps:** update dependency trivy to v0.69.3 68fc0c6
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 14ce138

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 0a27d32

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 f3ab7c2
* **deps:** update dependency opentofu to v1.11.2 30939c7
* **deps:** update dependency opentofu to v1.11.3 47ea6c7
* **deps:** update dependency opentofu to v1.11.4 5525b4e
* **deps:** update dependency opentofu to v1.11.5 2dfaa90
* **deps:** update dependency pre-commit to v4.4.0 43b4f80
* **deps:** update dependency pre-commit to v4.5.0 004bc4f
* **deps:** update dependency pre-commit to v4.5.1 2b34f56
* **deps:** update dependency tflint to v0.60.0 4ed1cfe
* **deps:** update dependency tflint to v0.61.0 a68da05
* **deps:** update dependency trivy to v0.67.1 edb0373
* **deps:** update dependency trivy to v0.67.2 dcc9695
* **deps:** update dependency trivy to v0.68.1 10acb3e
* **deps:** update dependency trivy to v0.68.2 78ed2c4
* **deps:** update dependency trivy to v0.69.0 a6bbb1c
* **deps:** update dependency trivy to v0.69.1 ee61000
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 e08bf33
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 fbac59d
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 7103c90
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 602d142
* **deps:** update tools b22f9f0
